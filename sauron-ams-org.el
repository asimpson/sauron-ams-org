...
;; Version: 0.2.2
;; Package-Requires: ((sauron "0.10") (org "9.1.13"))
;; Keywords: sauron, org
;; URL: https://github.com/asimpson/sauron-ams-org/
...
Also schedule event for when deadline is due."
  (let* ((deadline (org-entry-get nil "DEADLINE"))
         (task (nth 4 (org-heading-components)))
         (diff (org-time-stamp-to-now deadline t))
         (interval (number-to-string (round (/ diff 60)))) msg)
    (when (and (< diff 300)
               (> diff 0))
